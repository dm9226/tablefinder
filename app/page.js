...
const QUICK_SEARCHES = [
  { label: "Italian tonight, NYC, 2 people", icon: "🍝" },
  { label: "Brunch Saturday, SF, party of 4", icon: "🥂" },
  { label: "Steakhouse Friday 8pm, Chicago, 2", icon: "🥩" },
  { label: "Sushi this weekend, LA, 4 people", icon: "🍣" },
];
  ...
  const send = async (overrideText) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 429) {
          throw new Error("You've hit the search limit (20/hour). Grab a drink and try again shortly.");
        }
      ...
      <div style={{ minHeight: "100vh", background: "#12100E", fontFamily: "'Outfit', sans-serif" }}>
        ...
        >
          ...
          >
            ...
            >
              One search across OpenTable, Resy, Yelp, and Google. Tell us what you
              want — our AI agent finds every available table and links you directly
              to book.
            </p>
            ...
            <div style={{ maxWidth: 620, margin: "0 auto", animation: "fadeUp 0.8s ease 0.2s both" }}>
              ...
              >
                ...
                <input
                  ...
                  placeholder="Italian dinner for 2 tonight in Manhattan..."
                  style={{
                    flex: 1,
                    border: "none",
                    outline: "none",
          ...
          >
            {[
              ...
              },
              {
                ...
                title: "Discover",
                icon: "🔍",
                desc: "Our AI searches every major reservation platform simultaneously, finding options you'd miss checking one by one.",
              },
              {
                step: "03",
                title: "Dine",
    ...
    <div style={{ minHeight: "100vh", background: "#12100E", fontFamily: "'Outfit', sans-serif" }}>
        ...
        >
          ...
          <div
            style={{
              ...
              gap: 6,
              background: loading
                ? "rgba(232,168,109,0.1)"
                : "rgba(100,200,100,0.08)",
              padding: "5px 12px",
              borderRadius: 20,
              fontSize: 12,
              fontWeight: 500,
              color: loading ? "#E8A86D" : "#7BC47F",
            }}
          >
            <div
              style={{
                ...
                height: 6,
                borderRadius: "50%",
                background: loading ? "#E8A86D" : "#7BC47F",
      ...
      >
        ...
        {messages.length === 0 && !loading && (
          ...
          >
            ...
            >
              Describe your ideal meal — I'll find available tables across every
              platform.
            </p>
            <div
              style={{
              ...
              <div>
                ...
                >
                  ...
                  {msg.searchCount > 0 && (
                    <span
                      style={{
                        background: "rgba(232,168,109,0.08)",
                        border: "1px solid rgba(232,168,109,0.12)",
                        borderRadius: 10,
                        padding: "2px 8px",
                        fontSize: 11,
                        color: "#E8A86D",
          ...
          <div style={{ animation: "fadeUp 0.3s ease" }}>
            ...
            <div
              style={{
                ...
                gap: 12,
                background: "#1A1612",
                border: "1px solid rgba(232,168,109,0.1)",
                borderRadius: 12,
                padding: "14px 20px",
              }}
            >
              ...
              <span style={{ color: "#E8A86D", fontSize: 13, fontWeight: 500 }}>
      ...
      <div
        style={{
          ...
          right: 0,
          zIndex: 100,
          background: "linear-gradient(transparent, #12100E 30%)",
      ...
      >
        ...
        >
          <input
            ...
            onChange={(e) => setInput(e.target.value)}
            onKeyDown={(e) => e.key === "Enter" && send()}
            placeholder="Sushi for 4, this Saturday, downtown..."
            disabled={loading}
            style={{
              flex: 1,
              border: "none",
          ...
          <button
            ...
            style={{
              ...
              flexShrink: 0,
              background:
                input.trim() && !loading ? "#E8A86D" : "rgba(255,255,255,0.06)",
              color: input.trim() && !loading ? "#1A1612" : "#5A5248",
        ...
        >
          Results link directly to booking platforms · tablefinder.ai
        </p>
      </div>
    </div>
  );
